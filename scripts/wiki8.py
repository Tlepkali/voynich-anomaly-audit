...
TARGET=45000
SEEDS={"eu":["historia","zientzia","hiria","musika","landare","matematika","gerra","kultura","medikuntza","astronomia","filosofia","estatua","animalia","literatura","trenbide","hizkuntza"],
             "гүн","улс","амьтан","уран","төмөр","газар"],
       "fi":["historia","tiede","kaupunki","musiikki","kasvi","matematiikka","sota","kulttuuri","laaketiede","tahtitiede","filosofia","valtio","elain","kirjallisuus","rautatie","kieli"]}
